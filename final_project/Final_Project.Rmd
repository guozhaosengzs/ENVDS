...
To do so, I first calculated the absolute proportional differences between __DSCI_Area__ and __DSCI_Pop__ $$\frac{|\text{DSCI}_{Area} - \text{DSCI}_{population}|}{\text{DSCI}_{Area} + \text{DSCI}_{population}}$$, and picked the top three weeks that the most discrepancies that are present: 2017-08-15, 2015-08-04, 2018-09-18.
